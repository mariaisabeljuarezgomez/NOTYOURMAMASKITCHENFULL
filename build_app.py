...
<!-- Fix 5b - Floating Zoom Buttons -->
<div id="zoom-controls" style="position:fixed; right:20px; bottom:100px; display:flex; flex-direction:column; gap:8px; z-index:2100;">
    <button onclick="applyZoom(1.2)" style="width:44px;height:44px;border-radius:50%;background:rgba(0,0,0,0.85);color:#fff;border:1px solid #555;font-size:22px;cursor:pointer;display:flex;align-items:center;justify-content:center;">＋</button>
    <button onclick="applyZoom(0.833)" style="width:44px;height:44px;border-radius:50%;background:rgba(0,0,0,0.85);color:#fff;border:1px solid #555;font-size:22px;cursor:pointer;display:flex;align-items:center;justify-content:center;">－</button>
</div>
