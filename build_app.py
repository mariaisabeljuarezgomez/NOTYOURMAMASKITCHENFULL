...
function addFromTray(src) {{
    ...
    docV2.elements.push({{id, type:'image', src, x, y, width:400, height:400, zIndex:20, opacity:1, rotation:0, visible:true, locked:false, layerRole:'content'}});
...
<div id="zoom-controls" style="position:fixed; bottom:20px; right:20px; display:none; gap:10px; z-index:2000; flex-direction:column; padding:8px; background:rgba(0,0,0,0.85); border:1px solid #444; border-radius:12px; box-shadow: 0 8px 32px rgba(0,0,0,0.5);">
