...
<div id="zoom-controls" style="position:fixed; right:20px; bottom:200px; display:flex; flex-direction:column; gap:12px; z-index:9999; padding:8px; background:rgba(0,0,0,0.85); border:1px solid #444; border-radius:12px; box-shadow: 0 8px 32px rgba(0,0,0,0.5);">
